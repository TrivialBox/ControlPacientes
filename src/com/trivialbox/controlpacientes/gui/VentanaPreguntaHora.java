 ...
 * @author root
 */
public class VentanaPreguntaHora extends javax.swing.JInternalFrame {

    /**
     * Creates new form VentanaPreguntaHora
     */
    public VentanaPreguntaHora() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaPreguntaHora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaPreguntaHora().setVisible(true);
            }
        });
    }
