 ...
 * @author root
 */
public class VentanaPreguntaFecha extends javax.swing.JInternalFrame {

    /**
     * Creates new form VentanaPreguntaFecha
     */
    public VentanaPreguntaFecha() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaPreguntaFecha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaPreguntaFecha().setVisible(true);
            }
        });
    }
